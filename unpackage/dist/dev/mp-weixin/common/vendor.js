...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__ACDA83A",
    appName: "MeiTuan-Clone",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"MeiTuan-Clone","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*****************************************************!*\
  !*** D:/HBuilderX/project/MeiTuan-Clone/pages.json ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function startLoading() {
  _index.default.commit('request_show_loading');
  uni.showLoading({
    title: '加载中'
  });
}
function endLoading() {
  _index.default.commit('request_hide_loading');
  uni.hideLoading();
}

/* 请求 */
function uniRequest(url, data, method, isShow) {
  var ct = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'application/x-www-form-urlencoded';
  var retPromiseCbFunc = function retPromiseCbFunc(Resolve, Reject) {
    if (isShow) {
  ...
  var retPromise = new Promise(retPromiseCbFunc);
  return retPromise;
}

/* 请求 */
function uniRequestMulti(url, data, method, isShow) {
  var ct = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'application/json';
  var retPromiseCbFunc = function retPromiseCbFunc(Resolve, Reject) {
    if (isShow) {
      showFullScreenLoading(); //开始加载
    }
...
/* 96 */
/*!******************************************************************!*\
  !*** D:/HBuilderX/project/MeiTuan-Clone/pages/index/EventBus.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
